...
\includegraphics[scale=0.35]{HEAnet-broken.png}
\end{frame}

\begin{frame}[fragile]
\frametitle{Live Demo - Fixing the site}
\includegraphics[scale=0.50]{salt-master-starts-heanet2016-web-service.png}
\end{frame}


\begin{frame}[fragile]
\frametitle{Live Demo - Site back up}
\includegraphics[scale=0.35]{HEAnet-works.png}
\end{frame}
